...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Mocks
{
    public class PersistedGrantMock
    {
        ...
        public static Faker<PersistedGrant> PersistedGrantFaker(string key, Guid? subjectId = null)
        {
            var persistedGrantFaker = new Faker<PersistedGrant>()
                ...
                .RuleFor(o => o.SubjectId, f => subjectId == Guid.Empty ? f.Random.Number(int.MaxValue).ToString() : subjectId.ToString());

            return persistedGrantFaker;
        }

        public static PersistedGrant GenerateRandomPersistedGrant(string key, Guid? subjectId = null)
        {
